...
(select cast(order_key as integer) as order_key,cast(customer_key as integer) as customer_key from fact_sales_order_rename)

select order_key,customer_key from fact_sales_order_cast